...
export interface ApiGroupGroup extends Schema.CollectionType {
  ...
  attributes: {
    Name_group: Attribute.String;
    Date_Group: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiLecturesLectures extends Schema.CollectionType {
  collectionName: 'lecture';
  info: {
    singularName: 'lectures';
    pluralName: 'lecture';
    displayName: 'Lecture';
    description: '';
  };
  ...
  attributes: {
    lecuter_number: Attribute.String & Attribute.Required;
    quiz: Attribute.String & Attribute.Required;
    task: Attribute.String & Attribute.Required;
    link_lecture: Attribute.String & Attribute.Required;
    upload: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    group: Attribute.Date & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiStudentsStudents extends Schema.CollectionType {
  collectionName: 'student_data';
  info: {
    singularName: 'students';
    pluralName: 'student-data';
